...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{../out/part_1a}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{../out/cos}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{../out/fft}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{../out/rect_fft}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.35\textwidth]{../out/lenna_reconstructed_mag_log}
	\includegraphics[width=.35\textwidth]{../out/lenna_reconstructed_phase}
